...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        Attribute.on_site.get(slug="poll_number_value").delete()
        Attribute.on_site.get(slug="poll_text_value").delete()
        Attribute.on_site.get(slug="poll_location_value").delete()
        Attribute.on_site.get(slug="contact_location").delete()
